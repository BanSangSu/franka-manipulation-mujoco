...
This project is based on the iRobMan – [MuJoCo Workspace repository from TU Darmstadt](https://gitlab.pearl.informatik.tu-darmstadt.de/teaching/irobman2526-finalproject).
After cloning the original workspace, we developed our own robot system on top of it, extending its MuJoCo-based manipulation environment with custom functionalities and controls.
